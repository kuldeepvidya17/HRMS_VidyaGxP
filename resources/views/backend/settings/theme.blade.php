    ...
    <div class="col-md-8 offset-md-2">
        ...
        <form action="{{route('settings.theme')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-2">
                    <div class="img-thumbnail float-end"><img src="{{!empty($settings->logo) ? asset('storage/settings/theme/'.$settings->logo):asset('assets/img/logovidyagxp.png')}}" alt="logo" width="40" height="40"></div>
                </div>
            </div>  
            <div class="form-group row">
                ...
                <div class="col-lg-2">
                    <div class="img-thumbnail float-end"><img src="{{ !empty($settings->favicon) ? asset('storage/settings/theme/'.$settings->favicon):asset('assets/img/logovidyagxp.png') }}" class="img-fluid" width="16" height="16" alt="favicon"></div>
                </div>
            </div>
            {{-- <div class="form-group row">
                <div class="col-6">
