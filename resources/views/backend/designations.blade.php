                    ...
                    @if (!empty($designations->count()))
                        ...
                        @foreach ($designations as $designation)
                            <tr>
                                ...
                                <td>{{ $designation->department ? $designation->department->name : 'No Department' }}</td> <!-- Check if department exists -->
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a data-id="{{ $designation->id }}" data-name="{{ $designation->name }}" data-department="{{ $designation->department ? $designation->department->name : 'No Department' }}" class="dropdown-item editbtn" href="javascript:void(0)" data-toggle="modal">
                                                <i class="fa fa-pencil m-r-5"></i> Edit
                                            </a>
                                            <a data-id="{{ $designation->id }}" class="dropdown-item deletebtn" href="javascript:void(0)" data-toggle="modal">
