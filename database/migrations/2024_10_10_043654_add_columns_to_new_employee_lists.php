...
return new class extends Migration
{
    ...
    {
        Schema::table('new_employee_lists', function (Blueprint $table) {
            $table->string('Employee_id')->nullable(); // Unique Employee ID, still using string for IDs
            ...
            $table->longText('reporting_manager')->nullable();
            $table->longText('empsalary')->nullable();
